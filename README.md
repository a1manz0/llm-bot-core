...
Бэкенд‑сервис на FastAPI с многоуровневой памятью для Телеграм‑бота. Использует PostgreSQL для хранения диалогов, Directus как админ‑панель и, опционально, Qdrant для семантического поиска (RAG).
